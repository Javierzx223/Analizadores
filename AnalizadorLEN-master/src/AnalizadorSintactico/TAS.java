...
public class TAS {
    ...
    public TAS() {
        ...
        tabla[0][12] = "clase";
        tabla[0][13] = "extiende";
        tabla[0][14] = "implementa";
        tabla[0][15] = "retornar";
        tabla[0][16] = "<<Acceso>>";
        tabla[0][17] = "defecto";
        tabla[0][18] = "principal";
        tabla[0][19] = "<<bool>>";
        tabla[0][20] = ":";
        tabla[0][21] = ";";
        tabla[0][22] = "=";
        ...
        tabla[0][43] = "<Clase>";
        tabla[0][44] = "<Herencia>";
        tabla[0][45] = "<Implementacion>";
        tabla[0][46] = "<Body>";
        tabla[0][47] = "<Atributo o Metodo>";
        tabla[0][48] = "<AUX10>";
        tabla[0][49] = "<AUX11>";
        tabla[0][50] = "<Retorno>";
        tabla[0][51] = "<Cuerpo>";
        tabla[0][52] = "<Sentencia>";
        tabla[0][53] = "<AUX9>";
        tabla[0][54] = "<AUX1>";
        tabla[0][55] = "<AUX2>";
        tabla[0][56] = "<AUX3>";
        tabla[0][57] = "<Operacion>";
        tabla[0][58] = "<O1>";
        tabla[0][59] = "<O2>";
        tabla[0][60] = "<O3>";
        tabla[0][61] = "<Llamada>";
        tabla[0][62] = "<AUX5>";
        tabla[0][63] = "<AUX6>";
        tabla[0][64] = "<Condicion>";
        tabla[0][65] = "<AUX8>";
        tabla[0][66] = "<AUX4>";
        tabla[0][67] = "<Declaracion>";
        tabla[0][68] = "<AUX7>";
        tabla[1][0] = "0";
        tabla[1][12] = "s1";
        tabla[2][0] = "1";
        ...
        g[2].t.add(" <<id>>");
        g[3].t.add("<Herencia>");
        g[4].t.add("<Implementacion>");
        g[4].t.add("implementa");
        g[4].t.add("<<id>>");
        g[4].t.add("<AUX7> ");
        g[5].t.add("<Implementacion>");
        g[6].t.add("<Body>");
        g[6].t.add("<<Acceso>>");
        g[6].t.add("<Atributo o Metodo>");
        g[7].t.add("<Body>");
        g[8].t.add("<Atributo o Metodo>");
        g[8].t.add("<Declaracion>");
        g[8].t.add(";");
        g[8].t.add("<Body> ");
        g[9].t.add("<Atributo o Metodo>");
        g[9].t.add("<<Tipodato>>");
        g[9].t.add("<<id>>");
        g[9].t.add("(");
        g[9].t.add("<AUX10>");
        ...
        g[10].t.add("}");
        g[10].t.add("<Body>");
        g[11].t.add("<Atributo o Metodo>");
        g[11].t.add("principal");
        g[11].t.add("(");
        g[11].t.add(")");
        g[11].t.add("{");
        g[11].t.add("<Cuerpo>");
        ...
        g[18].t.add("<Retorno>");
        g[19].t.add("<Cuerpo>");
        g[19].t.add("<Sentencia>");
        g[19].t.add("<Cuerpo> ");
        g[20].t.add("<Cuerpo>");
        g[21].t.add("<Sentencia>");
        g[21].t.add("si");
        g[21].t.add("(");
        g[21].t.add("<Condicion>");
        g[21].t.add(")");
        g[21].t.add("<Sentencia>");
        g[21].t.add("<AUX1> ");
        g[22].t.add("<Sentencia>");
        g[22].t.add("mientras");
        g[22].t.add("(");
        g[22].t.add("<Condicion>");
        g[22].t.add(")");
        g[22].t.add("<Sentencia> ");
        g[23].t.add("<Sentencia>");
        g[23].t.add("sea");
        g[23].t.add("(");
        g[23].t.add("<<id>>");
        g[23].t.add(")");
        ...
        g[23].t.add("}");
        g[23].t.add("<Sentencia> ");
        g[24].t.add("<Sentencia>");
        g[24].t.add("hacer");
        g[24].t.add("<Sentencia>");
        g[24].t.add("mientras");
        g[24].t.add("(");
        g[24].t.add("<Condicion>");
        g[24].t.add(")");
        g[24].t.add("; ");
        g[25].t.add("<Sentencia>");
        g[25].t.add("{");
        g[25].t.add("<Cuerpo>");
        g[25].t.add("} ");
        g[26].t.add("<Sentencia>");
        g[26].t.add("para");
        g[26].t.add("(");
        g[26].t.add("<<id>>");
        g[26].t.add("=");
        g[26].t.add("<AUX2>");
        g[26].t.add(";");
        g[26].t.add("<Condicion>");
        g[26].t.add(";");
        g[26].t.add("<<id>>");
        g[26].t.add("<AUX9>");
        g[26].t.add(")");
        g[26].t.add("<Sentencia>");
        g[27].t.add("<Sentencia>");
        g[27].t.add("<Declaracion>");
        g[27].t.add("; ");
        g[28].t.add("<Sentencia>");
        g[28].t.add("<<id>>");
        g[28].t.add("<AUX9>");
        g[28].t.add(";");
        g[29].t.add("<Sentencia>");
        g[29].t.add("leer");
        g[29].t.add("(");
        g[29].t.add("<<id>>");
        g[29].t.add(")");
        g[29].t.add("; ");
        g[30].t.add("<Sentencia>");
        g[30].t.add("escribir");
        g[30].t.add("(");
        g[30].t.add("<Operacion>");
        g[30].t.add(")");
        g[30].t.add("; ");
        g[31].t.add("<Sentencia>");
        g[31].t.add(";");
        g[32].t.add("<AUX9>");
        g[32].t.add("=");
        g[32].t.add("<Operacion> ");
        g[33].t.add("<AUX9>");
        g[33].t.add("*");
        g[33].t.add("<AUX2> ");
        g[34].t.add("<AUX1>");
        g[34].t.add("sino");
        g[34].t.add("<Sentencia> ");
        g[35].t.add("<AUX1>");
        g[36].t.add("<AUX2>");
        g[36].t.add("<<id>>");
        g[36].t.add("<Llamada>");
        ...
        g[44].t.add("defecto");
        g[44].t.add(":");
        g[44].t.add("<Sentencia>");
        g[44].t.add("cambio");
        g[44].t.add("; ");
        g[45].t.add("<Operacion>");
        g[45].t.add("<Operacion>");
        g[45].t.add("+");
        g[45].t.add("<O1> ");
        g[46].t.add("<Operacion>");
        g[46].t.add("<O1> ");
        g[47].t.add("<O1>");
        g[47].t.add("<O1>");
        g[47].t.add("/");
        ...
        g[62].t.add("<AUX4>");
        g[62].t.add("<<opbool2>>");
        g[62].t.add("<Condicion>");
        g[63].t.add("<AUX4>");
        g[64].t.add("<Declaracion>");
        g[64].t.add("<<Tipodato>>");
        g[64].t.add("<<id>>");
        g[64].t.add("<AUX7> ");
        g[65].t.add("<AUX7>");
    ...
    public String analizar(ArrayList<String> pila, ArrayList<String> cadena) {
        ...
        if (intersec.equals("Aceptar")) {
            aux = aux + ("Sintaxis correcta \n");
        } else {
            aux = aux + ("error \n");
        }
        return aux;
